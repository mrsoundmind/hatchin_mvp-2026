...
export function RightSidebar({ activeProject, activeTeam, activeAgent }: RightSidebarProps) {
  ...
  if (activeView === 'none') {
    return (
      <aside className="w-80 hatchin-bg-panel rounded-2xl p-6 flex items-center justify-center my-2.5">
  ...
  return (
    <aside className="w-80 hatchin-bg-panel rounded-2xl p-6 overflow-y-auto my-2.5 ml-[8px] mr-[8px]">
      <div className="flex items-center gap-2 mb-4">
